...
?>
<body>
  <div class="col-12" style="margin-top: 0.8em;" id="tableCSS">
    <center style="width:100%;">
          ...
          <tr>
            <form action="postUpdate.php?w=<?php echo $donnees['num_page'];?>" method="POST" enctype="multipart/form-data">
              ...
              <td>
                ...
                <label class="labelFont">Règlement Jeu - Tirage :</label>
                <!-- On limite le fichier à 4Mo -->
                <input type="hidden" name="MAX_FILE_SIZE" value="4000000">
                <input type="file" name="reglement_jeu_tirage"/>
              </td>
              <td>
      ...
      <center><a href="index.php"><button type="button" class="btn btn-danger" style="margin-top: 1em;">Annuler</button></a></center>
